...
# carregando a base de snistros de transito do site da PCR para o ano de 2019
...
#removendo colunas "numero_cruzamento", "referencia_cruzamento" e "endereco_cruzamento" (atribuindo nulo a elas) para deixar apenas as mesmas variáveis dos outros anos
...
sinistrosRecifeRaw[, c(3:6, 8:10, 12:14)] <- lapply(sinistrosRecifeRaw[, c(3:6, 8:10, 12:14)], as.factor)
